...
from pydantic import BaseModel, Field, PrivateAttr, PrivateAttr
...
class SpreadDefinition(BaseModel):
    ...
    layout: Optional[SpreadLayout] = None  # Populated after loading
...
class DrawnCard(BaseModel):
    ...
    def description(self) -> dict[str, str]:
        return self._get_card_data().description

    @property
    def reading_aspects(self) -> dict[str, Any]:
        return self._get_card_data().reading_aspects

    @property
    def contextual_meanings(self) -> dict[str, Any]:
        return self._get_card_data().contextual_meanings

    def get_tk_meaning(self, orientation: str = "upright", lang: str = "en") -> str:
        return self._get_card_data().get_tk_meaning(orientation, lang)

    def get_waite_meaning(self, orientation: str = "upright") -> str:
        return self._get_card_data().get_waite_meaning(orientation)
